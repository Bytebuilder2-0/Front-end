...
const ApointmentChecking = () => {
	...
	useEffect(() => {
		axios
			...
			.then((res) =>
				setAppointments(res.data.reverse().filter((appt) => appt.status === "Checking"))
			)
									...
									<TableRow key={appointment._id}>
												...
												sx={{
													color:
														appointment.status === "Checking"
															...
															? "green"
															: ["Cancelled", "Reject1"].includes(appointment.status)
															? "red"
															: "gray",
													fontWeight: 600,
										...
										<TableCell align="center">
											<Tooltip title="Accept">
												<IconButton
													color="success"
													onClick={() => handleClickAction(appointment, "Accept")}
												>
											...
											<Tooltip title="Reject">
												<IconButton
													color="error"
													onClick={() => handleClickAction(appointment, "Reject")}
												>
