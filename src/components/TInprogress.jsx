...
function TInprogress() {
  ...
  const handleOpenDialog = async (appointmentId) => {
    try {
      const response = await axios.get(
        `${API_URL}/${appointmentId}/techMessage`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleTechnicianSuggestion = async () => {
    try {
      await axios.put(
        `${API_URL}/${selectedAppointmentId}/tSuggestionWrite`,
  ...
  const handleTaskCompletionConfirm = async () => {
    ...
    try {
      await axios.put(
        `${API_URL}/${appointmentId}/workload/${taskId}`,
        { status: "Completed" },
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleAllStepsCompletionConfirm = async () => {
    ...
    try {
      await axios.put(
        `${API_URL}/${appointmentToComplete}/tStatusUpdate`,
        { status: "Task Done" },
        {
          headers: {
            Authorization: `Bearer ${token}`,
