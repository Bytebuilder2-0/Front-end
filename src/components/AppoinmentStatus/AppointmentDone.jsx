...
const AppointmentDone = ({ appointment }) => {
  ...
  return (
    <Box sx={{ padding: "20px" }}>
      ...
      <Typography sx={{ color: "green" }}>Appointment - Completed</Typography>
      ...
      >
        ...
        <Typography variant="body2" sx={{ mb: 2 }}>
          Your vehicle is ready for pickup. Please complete the payment and
          leave feedback.
        </Typography>
        ...
        {completedTasks.map((task, index) => (
          <ListItem key={index} sx={{ pl: 0 }}>
            ...
            <ListItemText
              ...
              secondary={
                task.completedBy ? `Completed by: ${task.completedBy}` : null
              }
            />
          </ListItem>
        ))}
