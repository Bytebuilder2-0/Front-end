...
const AppointmentPending = ({ appointment, onCancel }) => {
  ...
  return (
    <Box sx={{ padding: "20px" }}>
      ...
      <Typography varient="caption" sx={{ color: "green" }}>
        {" "}
        Appoinment - Pending
      </Typography>
      ...
      >
        ...
        <Typography
          variant="body1"
          sx={{ my: 2, color: "#595959", fontSize: "14" }}
        >
        ...
        {/* Friendly Info Message */}
        <Typography variant="body2" gutterBottom sx={{ padding: "3px" }}>
          Vehicle Model : {appointment.model}
        </Typography>
      ...
      >
        <Typography variant="body2">
          To book a new appointment for this vehicle, you must first cancel this
          pending appointment. After cancellation, you can immediately submit a
          new booking request.
        </Typography>
      </Box>
    </Box>
