      ...
      const fetchCounts = async () => {
        ...
        try {
          const [statusResponse, technicianResponse, departmentStatusResponse] =
            await Promise.all([
              axios.get(`${baseURL}/appointments/statusCountsc`),
              axios.get(`${baseURL}/appointments/statusCountscheck`),
              axios.get(`${baseURL}/appointments/departmentStatusData`),
            ]);
                    ...
                    >
                      <CardContent sx={{ p: isSmallScreen ? 1 : 2 }}>
                        ...
                        >
                          ...
                          Waiting: {counts.waiting}, Rejected: {counts.rejected}
                          )
                        </Typography>
                      </CardContent>
                    </Card>
