...
const Signup = () => {
  ...
  const validate = () => {
    ...
    if (isSpecialRole && !formData.roleId.trim())
      newErrors.roleId = `${formData.role} ID required`;
    if (!formData.termsAccepted)
      newErrors.termsAccepted = "You must accept the terms and conditions"; // Validation for checkbox
    return newErrors;
  };
  ...
  const avatarStyle = { backgroundColor: "#388e3c", color: "#fff" }; //rgb(47 154 78) ekata danna
